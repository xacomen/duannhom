...
public class NhanVienRepository {
    ...
    public void insert(NhanVien model) {
        ...
        DBContext.executeUpdate(sql, model.getMaNV(), model.getPassword(), model.getTenNV(), model.getHinh(), model.getCMND(), model.getDiaChi(), model.getDienThoai(), model.getNgaySinh(), model.getNgayVaoLam(), model.getVaiTro(), model.getViTri());
    }
    ...
    public void update(NhanVien model) {
        ...
        DBContext.executeUpdate(sql, model.getPassword(), model.getTenNV(), model.getHinh(), model.getCMND(), model.getDiaChi(), model.getDienThoai(), model.getNgaySinh(), model.getNgayVaoLam(), model.getVaiTro(), model.getViTri(), model.getMaNV());

    }

//    public void updateTaikhoan(NhanVien model) {
//        String sql = "UPDATE NhanVien SET MaNV=? WHERE MaNV=?";
//        DBContext.executeUpdate(sql, model.getMaNV(), model.getMaNV());
//
//    }
    public void delete(String MaNV) {
        String sql = "DELETE FROM NHANVIEN WHERE MaNV=?";
        DBContext.executeUpdate(sql, MaNV);
    }
